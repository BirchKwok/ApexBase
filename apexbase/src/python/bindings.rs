...
impl ApexStorageImpl {
    ...
    /// Read a BLOB value by `_id` and column name.
    ...
    /// Read multiple BLOB values by `_id` and column name.
    ...
    /// Read a byte range from a BLOB value by `_id` and column name.
    ...
    /// Read byte ranges from multiple BLOB values by `_id` and column name.
