...
| [Architecture Review & Refactoring Plan (2026-09)](ARCHITECTURE_REVIEW_2026_09.md) | Maintainers reviewing architecture risks and phased improvements |
| [Remaining Architecture Work & Priorities](ARCHITECTURE_REFACTOR_REMAINING.md) | Maintainers tracking open contracts, execution order, and acceptance evidence |
